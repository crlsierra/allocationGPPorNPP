...
\begin{figure}[t]
   \centering
   \includegraphics{Fig1_conceptualDiagram.pdf} % requires the graphicx package
...
\begin{figure}[t]
   \centering
   \includegraphics[scale=0.9]{Fig2_GPPversusNPP_TT.pdf} % requires the graphicx package
...
\begin{figure}[t]
   \centering
   \includegraphics[scale=0.9]{Fig3_TT_contributions.pdf} % requires the graphicx package
...
\begin{figure}[t]
   \centering
   \includegraphics[scale=0.8]{Fig4_ageRespiredC.pdf} % requires the graphicx package
...
\begin{figure}[t]
   \centering
   \includegraphics[scale=0.9]{Fig5_radiocarbon.pdf} % requires the graphicx package
...
\codedataavailability{All data and code used for this manuscript is available in Zenodo at \url{https://doi.org/10.5281/zenodo.6548611}.}
